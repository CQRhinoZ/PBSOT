...
class Visualizer:
    ...
    def save_rank_result(self, query_indices, output, max_rank=5, vis_label=False, label_sort='ascending',
        ...
        for cnt, q_idx in enumerate(tqdm.tqdm(query_indices)):
            ...
            query_name = query_info['img_paths'].split('/')[-1].split('-')[0]
            ...
            for i in range(max_rank):
                ...
                gallery_name = gallery_info['img_paths'].split('/')[-1].split('-')[0]
                ...
                ax.set_title('{:.4f}/{}'.format(self.all_ap[q_idx], gallery_name))
                ax.axis("off")
            # if actmap:
            #     act_outputs = []
            #
